    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<!-- Added for external payment -->
		  <div class="form-group required">
			<label class="col-sm-2 control-label" for="input-project-key"><?php echo $project_key; ?></label>
			<div class="col-sm-10">
			  <input type="text" name="cardinity_project_key" value="<?php echo $cardinity_project_key; ?>" placeholder="<?php echo $project_key; ?>" id="input-project-key" class="form-control"/>
			  <?php if ($error_project_key) { ?>
			  <div class="text-danger"><?php echo $error_project_key; ?></div>
			  <?php } ?>
			</div>
		  </div>
		  <div class="form-group required">
			<label class="col-sm-2 control-label" for="input-project-secret"><?php echo $project_secret; ?></label>
			<div class="col-sm-10">
			  <input type="text" name="cardinity_project_secret" value="<?php echo $cardinity_project_secret; ?>" placeholder="<?php echo $project_secret; ?>" id="input-project-secret" class="form-control"/>
			  <?php if ($error_project_secret) { ?>
			  <div class="text-danger"><?php echo $error_project_secret; ?></div>
			  <?php } ?>
			</div>
		  </div>
