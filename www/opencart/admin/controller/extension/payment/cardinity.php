...
class ControllerExtensionPaymentCardinity extends Controller {
	...
	public function index() {
		...
		/**External payment */
		$data['project_key'] = $this->language->get('project_key');
		$data['project_secret'] = $this->language->get('project_secret');
		$data['entry_external'] = $this->language->get('entry_external');

		if (isset($this->error['project_key'])) {
			$data['error_project_key'] = $this->error['project_key'];
		} else {
			$data['error_project_key'] = '';
		}

		if (isset($this->error['project_secret'])) {
			$data['error_project_secret'] = $this->error['project_secret'];
		} else {
			$data['error_project_secret'] = '';
		}
		...
		/* Added for external pay */
		if (isset($this->request->post['cardinity_project_key'])) {
			$data['cardinity_project_key'] = $this->request->post['cardinity_project_key'];
		} else {
			$data['cardinity_project_key'] = $this->config->get('cardinity_project_key');
		}

		if (isset($this->request->post['cardinity_project_secret'])) {
			$data['cardinity_project_secret'] = $this->request->post['cardinity_project_secret'];
		} else {
			$data['cardinity_project_secret'] = $this->config->get('cardinity_project_secret');
		}

		if (isset($this->request->post['cardinity_external'])) {
			$data['cardinity_external'] = $this->request->post['cardinity_external'];
		} else {
			$data['cardinity_external'] = $this->config->get('cardinity_external');
		}
		/**Added for external pay */
